...
Description: Anonyme, datensparsame Terminbuchung (kein Tracking, keine Cookies, keine personenbezogenen Daten) + Grundseiten.
Version: 1.0
*/
      ...
      <div class="rc-modal" role="dialog" aria-modal="true" aria-label="Termin buchen">
        ...
        <div class="rc-steps">
          ...
          <div class="rc-step" data-step="done" hidden>
            ...
            <p class="rc-hint">Notiere dir den Code (oder mach einen Screenshot). Wir speichern keine Kontaktdaten &ndash;
              komm einfach zum gewählten Termin vorbei. Bis bald! 🔧</p>
 ...
 * ------------------------------------------------------------- */
add_action('init', function () {
    if (get_option('rc_setup_version') === '3') return;
...
<p><strong>Repair FFM</strong><br>[Name der verantwortlichen Person bzw. der Initiative/des Vereins]<br>[Straße und Hausnummer]<br>[PLZ und Ort]</p>
<p><strong>Kontakt:</strong><br>E-Mail: [E-Mail-Adresse]<br>[optional: Telefon]</p>
<h2>Organisationsform / Vertretung</h2>
<p><em>Sofern eingetragener Verein:</em> [Vereinsname e. V.], vertreten durch [Vorstand]. Registergericht: [Amtsgericht], Registernummer: [VR-Nr.].<br><em>Andernfalls verantwortlich als Privatperson/Initiative:</em> [Name].</p>
<h2>Verantwortlich für den Inhalt nach § 18 Abs. 2 MStV</h2>
<p>[Name]<br>[Anschrift wie oben]</p>
<h2>Art des Angebots</h2>
<p>Repair FFM ist ein ehrenamtliches, gemeinnütziges Reparatur-Angebot ohne Gewinnabsicht. Für Reparaturen wird kein Entgelt erhoben; Spenden sind freiwillig. Eine Umsatzsteuer-Identifikationsnummer besteht mangels wirtschaftlicher Tätigkeit nicht.</p>
...
<p>Die Inhalte dieser Seiten wurden mit größtmöglicher Sorgfalt erstellt. Für Richtigkeit, Vollständigkeit und Aktualität übernehmen wir jedoch keine Gewähr. Für Inhalte externer Links sind ausschließlich deren Betreiber verantwortlich; zum Zeitpunkt der Verlinkung waren keine Rechtsverstöße erkennbar.</p>
<p><em>Hinweis: Die mit [ ] markierten Angaben müssen vor der Veröffentlichung durch die echten, ladungsfähigen Daten ersetzt werden (kein Postfach). Ein vollständiges Impressum ist gesetzlich vorgeschrieben.</em></p>
RCHTML;
...
<p>Die Buchung erfolgt ohne Anmeldung. Wir erheben <strong>weder Name noch E-Mail noch Telefonnummer</strong>. Gespeichert werden ausschließlich der gewählte Termin, die Kategorie (z. B. IT oder E-Bike) und – nur wenn du sie freiwillig einträgst – eine kurze Problembeschreibung. Rechtsgrundlage ist unser berechtigtes Interesse an der Organisation der Reparatur-Termine (Art. 6 Abs. 1 lit. f DSGVO), bei freiwilligen Angaben deine Einwilligung (Art. 6 Abs. 1 lit. a DSGVO). Die Buchungsdaten werden nach dem jeweiligen Termin gelöscht. Da die Buchung anonym ist, können einzelne Buchungen keiner Person zugeordnet werden.</p>
<h2>Cookies</h2>
...
RCHTML;
    ...
    $pages = array(
        'termin-buchen' => array('Termin buchen',
            "<p>Such dir einen freien Termin aus &ndash; ganz anonym, ohne Name, ohne E-Mail. Du bekommst einen Buchungscode angezeigt und kommst damit einfach vorbei.</p>\n[repairffm_booking]"),
    ...
    update_option('rc_setup_version', '3');
}, 20);
